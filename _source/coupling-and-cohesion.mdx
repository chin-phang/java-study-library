...
and it's exactly the smell the [Law of Demeter](/docs/java/core-language#q5)
...
Tools compute this directly: JDepend and ArchUnit for Java, Structure101 for a
visual dependency graph. None of this requires manual counting — it's a build
...
If you have JDepend or an ArchUnit setup, run it against your package
